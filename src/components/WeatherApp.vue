...
// 1. 여기에 OpenWeatherMap에서 발급받은 API 키를 입력하세요.
const apiKey = "b6c39250c7938bd189a96e2b4d4fa9cf"; // <--- 중요! 이 부분을 꼭 수정해주세요.
